...
const Option = (props: OptionProps) => {
    const data = props.data as { label: string }; // Type assertion
...
export const useFormatters = () => {
    ...
    const formatCreateLabel = (label: any) => (
    ...
    const formatGroupLabel = (data: { label: string | number | bigint | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<React.AwaitedReactNode> | null | undefined; options: string | any[]; }) => (
